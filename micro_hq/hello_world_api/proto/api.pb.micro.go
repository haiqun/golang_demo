...
type ExampleService interface {
	...
	Call2(ctx context.Context, in *CallRequest, opts ...client.CallOption) (*CallResponse, error)
}
...
func (c *exampleService) Call2(ctx context.Context, in *CallRequest, opts ...client.CallOption) (*CallResponse, error) {
	req := c.c.NewRequest(c.name, "Example.Call2", in)
	out := new(CallResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type ExampleHandler interface {
	...
	Call2(context.Context, *CallRequest, *CallResponse) error
}

func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		Call(ctx context.Context, in *CallRequest, out *CallResponse) error
		Call2(ctx context.Context, in *CallRequest, out *CallResponse) error
	}
	type Example struct {
		example
	}
...
func (h *exampleHandler) Call2(ctx context.Context, in *CallRequest, out *CallResponse) error {
	return h.ExampleHandler.Call2(ctx, in, out)
}
